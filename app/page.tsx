...
export const metadata: Metadata = {
  ...
  description:
    'Licensed New Orleans plumber for emergencies, drain cleaning, water heaters, leaks, and repipes. Fast response, upfront pricing. Book online or call MS & P LLC.',
  alternates: {
    canonical: '/',
  },
  openGraph: {
